    ...
    <div className="relative">
      ...
      >
        ...
        <p className="text-[hsl(var(--muted-foreground))] mb-6">
          Built North America's largest tech and business internship newsletter,
          helping thousands of students land interviews at top companies. Our
          platform includes a comprehensive job board with 7,000+ active
          listings and solutions for universities to help them connect their
          students with employers. Our infrastructure monitors 10,000+ companies
          every 15 minutes using advanced web scraping and AI-powered data
          cleaning technology to ensure high-quality opportunities.
        </p>
